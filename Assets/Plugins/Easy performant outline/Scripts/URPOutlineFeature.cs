...
public class URPOutlineFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        var shouldUseDepthTarget = renderingData.cameraData.requiresDepthTexture && CameraUtility.GetMSAA(renderingData.cameraData.camera) <= 1 && !renderingData.cameraData.isSceneViewCamera;
        ...
        foreach (var outliner in outliners)
        {
            ...
            outline.renderPassEvent = RenderPassEvent.AfterRenderingSkybox;
